...
fun ConfirmationDialog(
    ...
    title: String,
    message: String = "",
    confirmButtonText: String = stringResource(R.string.confirmation_dialog__ok_button),
    dismissButtonText: String = stringResource(R.string.confirmation_dialog__cancel_button),
