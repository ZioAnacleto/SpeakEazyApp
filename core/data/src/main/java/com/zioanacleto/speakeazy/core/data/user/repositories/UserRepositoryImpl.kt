...
import com.zioanacleto.speakeazy.core.analytics.traces.returningTrace
...
class UserRepositoryImpl(
    ...
    override fun getUser(): Flow<Resource<UserModel>> =
        performanceTracesManager.returningTrace(
            this::class,
            "getUser"
        ) {
            localDataSource.getUser().flowOn(dispatcherProvider.io())
        }
